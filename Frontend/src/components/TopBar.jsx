...
const TopBar = () => {
    ...
    return (
        ...
        <div className="border-b box-border border-gray-200 dark:border-gray-800 flex px-3 py-0.5 items-center  bg-white dark:bg-black fixed right-0 left-0 z-30 m-auto max-w-[450px] transition-colors duration-300">
            <div className='flex-1 w-fit font-(family-name:--font-dancing) tracking-wide  text-3xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 
             bg-clip-text text-transparent '>InstaSocial</div>
